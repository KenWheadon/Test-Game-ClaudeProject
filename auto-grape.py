...
def action_set_1():
    while running:
        ...
        pyautogui.click()
        print("Mouse clicked")
        wait_time = random.uniform(7.5, 8.0)
...
def action_set_2():
    while running:
        ...
        for key in keys:
            ...
            time.sleep(0.25)
        wait_time = random.uniform(25.2, 30.5)
...
def run_grape_time():
    ...
    try:
        ...
        print("\nStopping Grape Time script...")
        running = False
        thread1.join()
        thread2.join()
        print("Grape Time script stopped.")

if __name__ == "__main__":
    print("Starting Grape Time script. Press Ctrl+C to stop.")
    run_grape_time()